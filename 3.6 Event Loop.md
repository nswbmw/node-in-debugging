...
关于 Event Loop 运作原理这篇文章（[https://cnodejs.org/topic/5a9108d78d6e16e56bb80882](https://cnodejs.org/topic/5a9108d78d6e16e56bb80882)）从 Node.js 和 Libuv 源码分析的非常透彻，本节就不赘述了。本节就拿出六道题来补充一下，放出一张关于 Event Loop 非常直观的图：
